...
@section('title', __('Projects') . ' - ' . __('Edit Project'))

@section('content')
<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('Edit Project') }}</div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <label class="form-control h-auto text-center p-4 form-control @error('image') is-invalid @enderror">
                            ...
                            <img src="{{ $project->imagePathWithTimestamp ? asset($project->imagePathWithTimestamp) : '' }}" class="mw-100" alt="{{ __('Choose file') }}">
                        </label>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="short_description" id="short_description" class="tinymce form-control @error('short_description') is-invalid @enderror">{{ old('short_description', $project->short_description) }}</textarea>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="tinymce form-control @error('short_description') is-invalid @enderror">{{ old('description', $project->description) }}</textarea>
