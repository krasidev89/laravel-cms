...
@section('title', __('Google Analytics') . ' - ' . __('Device Categories'))
...
<div class="card shadow-sm mb-3">
    <div class="card-header d-flex align-items-center bg-transparent">
        ...
        @can('sync')
        <a href="{{ route('backend.google-analytics.sync.device-categories') }}" class="btn d-flex flex-shrink-0 ml-auto p-0" data-toggle="tooltip" data-placement="left" title="{{ __('Google Analytics - Sync') }}">
            ...
            <div class="col-12 col-sm-4">
                <div class="form-group">
                    <select name="name" class="form-control google-analytics-select2 google-analytics-table-filters">
                        <option value="0">{{ __('All Device Categories') }}</option>
...
<div class="card shadow-sm mt-3">
    ...
    <div class="card-body">
        <table id="device-categories-table" class="table table-bordered" width="100%">
            <thead>
                <tr>
